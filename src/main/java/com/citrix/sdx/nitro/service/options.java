...
public class options 
{
	...
	/**
	 * sets filter field.
	 * @param filter set this with the filter string to perform filtered get operation on 
	 * specific type of resource. This is in json format.example: "port:80,servicetype:HTTP".
	 */
