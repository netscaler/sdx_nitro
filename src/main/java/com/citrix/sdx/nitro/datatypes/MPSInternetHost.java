...
public class MPSInternetHost extends MPSDatatype
{
	private String value;
	
	private MPSConstraintInternetHost[] constraints;
	
	public MPSInternetHost()
	{
		this(null);
	}
	
	public MPSInternetHost(String _value)
	{
		constraints = new MPSConstraintInternetHost[MPSConstants.GENERIC_CONSTRAINT];
					
		for(int i = 0; i < constraints.length; i++)
		{
			constraints[i] = new MPSConstraintInternetHost();
		}
		value = _value;
	}
