...
public class MPSIPAddress extends MPSDatatype
{
	private String value;
	
	private MPSConstraintIP[] constraints;
	...
	public MPSIPAddress(String _value)
	{
		constraints = new MPSConstraintIP[MPSConstants.GENERIC_CONSTRAINT];
					
		for(int i = 0; i < constraints.length; i++)
		{
			constraints[i] = new MPSConstraintIP();
		}
		value = _value;
	}
