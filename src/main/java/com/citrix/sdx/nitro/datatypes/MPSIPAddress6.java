...
public class MPSIPAddress6 extends MPSDatatype
{
	private String value;
	
	private MPSConstraintIP6[] constraints;
	
	public MPSIPAddress6()
	{
		this(null);
	}
	
	public MPSIPAddress6(String _value)
	{
		constraints = new MPSConstraintIP6[MPSConstants.GENERIC_CONSTRAINT];
					
		for(int i = 0; i < constraints.length; i++)
		{
			constraints[i] = new MPSConstraintIP6();
		}
		value = _value;
	}
