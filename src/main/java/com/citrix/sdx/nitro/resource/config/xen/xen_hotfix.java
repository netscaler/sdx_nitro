...
class xen_hotfix_response extends base_response
{
	public xen_hotfix[] xen_hotfix;
}

class xen_hotfix_responses extends base_response
{
	public xen_hotfix_response[] xen_hotfix_response_array;
}
...
public class xen_hotfix extends base_resource
{
	...
	/**
	 * <pre>
	 * Checking whether host fixes applied or not 
	 * </pre>
	 */
	...
	/**
	 * <pre>
	 * Steps required after Hotfix installation
	 * </pre>
	 */
	 ...
	 * </pre>
	 */
	public static xen_hotfix[] delete(nitro_service client, xen_hotfix[] resources) throws Exception
	{
		if(resources == null)
			throw new Exception("Null resource array");
		...
		if(resources.length == 1)
			return ((xen_hotfix[]) resources[0].delete_resource(client));
		
		return ((xen_hotfix[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static xen_hotfix[] get(nitro_service client) throws Exception
	{
		xen_hotfix resource = new xen_hotfix();
		resource.validate("get");
		return (xen_hotfix[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get xen hotfix.
	 */
	public static xen_hotfix get(nitro_service client, xen_hotfix resource) throws Exception
	{
		resource.validate("get");
		return ((xen_hotfix[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get xen hotfix in bulk.
	 * </pre>
	 */
	...
	*/
	public static xen_hotfix[] get_filtered(nitro_service service, String filter) throws Exception
	{
		xen_hotfix obj = new xen_hotfix();
		options option = new options();
		option.set_filter(filter);
		xen_hotfix[] response = (xen_hotfix[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static xen_hotfix[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		xen_hotfix obj = new xen_hotfix();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_hotfix[] response = (xen_hotfix[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_hotfix_response result = (xen_hotfix_response) service.get_payload_formatter().string_to_resource(xen_hotfix_response.class, response);
	...
	protected void validate(String operationType) throws Exception
	{
		...
		MPSString after_apply_guidance_validator = new MPSString();
		after_apply_guidance_validator.validate(operationType, after_apply_guidance, "\"after_apply_guidance\"");
		
		MPSString hot_fix_applied_validator = new MPSString();
		hot_fix_applied_validator.validate(operationType, hot_fix_applied, "\"hot_fix_applied\"");
