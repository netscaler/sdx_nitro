...
class ns_conf_download_policy_response extends base_response
{
	public ns_conf_download_policy[] ns_conf_download_policy;
}

class ns_conf_download_policy_responses extends base_response
{
	public ns_conf_download_policy_response[] ns_conf_download_policy_response_array;
}
...
public class ns_conf_download_policy extends base_resource
{
	 ...
	 * </pre>
	 */
	public static ns_conf_download_policy do_poll(nitro_service client, ns_conf_download_policy resource) throws Exception
	{
	 ...
	 */
	public static ns_conf_download_policy get(nitro_service client) throws Exception
	{
	...
	*/
	public static ns_conf_download_policy[] get_filtered(nitro_service service, String filter) throws Exception
	{
		ns_conf_download_policy obj = new ns_conf_download_policy();
		options option = new options();
		option.set_filter(filter);
		ns_conf_download_policy[] response = (ns_conf_download_policy[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static ns_conf_download_policy[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		ns_conf_download_policy obj = new ns_conf_download_policy();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		ns_conf_download_policy[] response = (ns_conf_download_policy[])obj.get_resources(service, option);
	...
	*/
	...
	{
		ns_conf_download_policy_response result = (ns_conf_download_policy_response) service.get_payload_formatter().string_to_resource(ns_conf_download_policy_response.class, response);
	...
	protected base_resource[] get_nitro_bulk_response(nitro_service service, String response) throws Exception
	{
		...
		if(result.errorcode != 0)
		{
			if (result.errorcode == SESSION_NOT_EXISTS)
				service.clear_session();
			throw new nitro_exception(result.message, result.errorcode, (base_response [])result.ns_conf_download_policy_response_array);
		}
		ns_conf_download_policy[] result_ns_conf_download_policy = new ns_conf_download_policy[result.ns_conf_download_policy_response_array.length];
		
		for(int i = 0; i < result.ns_conf_download_policy_response_array.length; i++)
		{
			result_ns_conf_download_policy[i] = result.ns_conf_download_policy_response_array[i].ns_conf_download_policy[0];
		}
		
		return result_ns_conf_download_policy;
	}
