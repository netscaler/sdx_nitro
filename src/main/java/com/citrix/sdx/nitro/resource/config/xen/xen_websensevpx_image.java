...
class xen_websensevpx_image_response extends base_response
{
	public xen_websensevpx_image[] xen_websensevpx_image;
}

class xen_websensevpx_image_responses extends base_response
{
	public xen_websensevpx_image_response[] xen_websensevpx_image_response_array;
}
...
public class xen_websensevpx_image extends base_resource
{
	 ...
	 * </pre>
	 */
	public static xen_websensevpx_image delete(nitro_service client, xen_websensevpx_image resource) throws Exception
	{
		resource.validate("delete");
		return ((xen_websensevpx_image[]) resource.delete_resource(client))[0];
	}
	 ...
	 * </pre>
	 */
	public static xen_websensevpx_image[] delete(nitro_service client, xen_websensevpx_image[] resources) throws Exception
	{
		if(resources == null)
		...
		if(resources.length == 1)
			return ((xen_websensevpx_image[]) resources[0].delete_resource(client));
		
		return ((xen_websensevpx_image[]) delete_bulk_request(client, resources));
	}
	 ...
	 * Use this operation to get websense XVA file.
	 */
	public static xen_websensevpx_image get(nitro_service client, xen_websensevpx_image resource) throws Exception
	{
		resource.validate("get");
		return ((xen_websensevpx_image[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get websense XVA file in bulk.
	 * </pre>
	 */
	...
	*/
	public static xen_websensevpx_image[] get_filtered(nitro_service service, String filter) throws Exception
	{
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_websensevpx_image[] response = (xen_websensevpx_image[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_websensevpx_image_response result = (xen_websensevpx_image_response) service.get_payload_formatter().string_to_resource(xen_websensevpx_image_response.class, response);
		...
		return result.xen_websensevpx_image;
	}
	...
	{
		xen_websensevpx_image_responses result = (xen_websensevpx_image_responses) service.get_payload_formatter().string_to_resource(xen_websensevpx_image_responses.class, response);
		if(result.errorcode != 0)
		{
			if (result.errorcode == SESSION_NOT_EXISTS)
				service.clear_session();
			throw new nitro_exception(result.message, result.errorcode, (base_response [])result.xen_websensevpx_image_response_array);
		}
		xen_websensevpx_image[] result_xen_websensevpx_image = new xen_websensevpx_image[result.xen_websensevpx_image_response_array.length];
		
		for(int i = 0; i < result.xen_websensevpx_image_response_array.length; i++)
		{
			result_xen_websensevpx_image[i] = result.xen_websensevpx_image_response_array[i].xen_websensevpx_image[0];
		}
		
		return result_xen_websensevpx_image;
	}
