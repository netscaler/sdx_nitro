...
class ns_conf_revision_history_response extends base_response
{
	public ns_conf_revision_history[] ns_conf_revision_history;
}

class ns_conf_revision_history_responses extends base_response
{
	public ns_conf_revision_history_response[] ns_conf_revision_history_response_array;
}
...
public class ns_conf_revision_history extends base_resource
{
	 ...
	 * </pre>
	 */
	public static ns_conf_revision_history[] get(nitro_service client) throws Exception
	{
		ns_conf_revision_history resource = new ns_conf_revision_history();
	...
	*/
	public static ns_conf_revision_history[] get_filtered(nitro_service service, String filter) throws Exception
	{
		ns_conf_revision_history obj = new ns_conf_revision_history();
		options option = new options();
		option.set_filter(filter);
		ns_conf_revision_history[] response = (ns_conf_revision_history[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static ns_conf_revision_history[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		ns_conf_revision_history obj = new ns_conf_revision_history();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		ns_conf_revision_history[] response = (ns_conf_revision_history[])obj.get_resources(service, option);
	...
	*/
	...
	{
		ns_conf_revision_history_response result = (ns_conf_revision_history_response) service.get_payload_formatter().string_to_resource(ns_conf_revision_history_response.class, response);
	...
	protected void validate(String operationType) throws Exception
	{
		...
		MPSString ns_conf_revisionfile_validator = new MPSString();
		ns_conf_revisionfile_validator.validate(operationType, ns_conf_revisionfile, "\"ns_conf_revisionfile\"");
