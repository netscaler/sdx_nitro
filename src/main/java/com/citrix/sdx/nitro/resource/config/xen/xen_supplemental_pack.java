...
class xen_supplemental_pack_response extends base_response
{
	public xen_supplemental_pack[] xen_supplemental_pack;
}

class xen_supplemental_pack_responses extends base_response
{
	public xen_supplemental_pack_response[] xen_supplemental_pack_response_array;
}
...
public class xen_supplemental_pack extends base_resource
{
	...
	/**
	 * <pre>
	 * Output of XenServer installation command
	 * </pre>
	 */
	...
	public static xen_supplemental_pack[] install(nitro_service client, xen_supplemental_pack[] resources) throws Exception
	{
		...
		return ((xen_supplemental_pack[]) perform_operation_bulk_request(client, resources, "install"));
	}
	 ...
	 * </pre>
	 */
	public static xen_supplemental_pack delete(nitro_service client, xen_supplemental_pack resource) throws Exception
	{
		resource.validate("delete");
		return ((xen_supplemental_pack[]) resource.delete_resource(client))[0];
	}
	 ...
	 * </pre>
	 */
	public static xen_supplemental_pack[] delete(nitro_service client, xen_supplemental_pack[] resources) throws Exception
	{
		if(resources == null)
			throw new Exception("Null resource array");
		...
		if(resources.length == 1)
			return ((xen_supplemental_pack[]) resources[0].delete_resource(client));
		
		return ((xen_supplemental_pack[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static xen_supplemental_pack[] get(nitro_service client) throws Exception
	{
		xen_supplemental_pack resource = new xen_supplemental_pack();
		resource.validate("get");
		return (xen_supplemental_pack[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get xen supplemental packs.
	 */
	public static xen_supplemental_pack get(nitro_service client, xen_supplemental_pack resource) throws Exception
	{
		resource.validate("get");
		return ((xen_supplemental_pack[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get xen supplemental packs in bulk.
	 * </pre>
	 */
	...
	*/
	public static xen_supplemental_pack[] get_filtered(nitro_service service, String filter) throws Exception
	{
		xen_supplemental_pack obj = new xen_supplemental_pack();
		options option = new options();
		option.set_filter(filter);
		xen_supplemental_pack[] response = (xen_supplemental_pack[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static xen_supplemental_pack[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		xen_supplemental_pack obj = new xen_supplemental_pack();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_supplemental_pack[] response = (xen_supplemental_pack[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_supplemental_pack_response result = (xen_supplemental_pack_response) service.get_payload_formatter().string_to_resource(xen_supplemental_pack_response.class, response);
		...
		return result.xen_supplemental_pack;
	}
	...
	protected void validate(String operationType) throws Exception
	{
		...
		MPSString output_validator = new MPSString();
		output_validator.validate(operationType, output, "\"output\"");
