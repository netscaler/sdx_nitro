...
class ns_ns_savedconfig_response extends base_response
{
	public ns_ns_savedconfig[] ns_ns_savedconfig;
}

class ns_ns_savedconfig_responses extends base_response
{
	public ns_ns_savedconfig_response[] ns_ns_savedconfig_response_array;
}
...
public class ns_ns_savedconfig extends base_resource
{
	...
	*/
	public static ns_ns_savedconfig[] get_filtered(nitro_service service, String filter) throws Exception
	{
		ns_ns_savedconfig obj = new ns_ns_savedconfig();
		options option = new options();
		option.set_filter(filter);
		ns_ns_savedconfig[] response = (ns_ns_savedconfig[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static ns_ns_savedconfig[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		ns_ns_savedconfig obj = new ns_ns_savedconfig();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		ns_ns_savedconfig[] response = (ns_ns_savedconfig[])obj.get_resources(service, option);
	...
	*/
	...
	{
		ns_ns_savedconfig_response result = (ns_ns_savedconfig_response) service.get_payload_formatter().string_to_resource(ns_ns_savedconfig_response.class, response);
