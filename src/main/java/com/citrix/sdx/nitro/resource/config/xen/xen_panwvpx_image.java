...
class xen_panwvpx_image_response extends base_response
{
	public xen_panwvpx_image[] xen_panwvpx_image;
}
...
public class xen_panwvpx_image extends base_resource
{
	 ...
	 * </pre>
	 */
	public static xen_panwvpx_image delete(nitro_service client, xen_panwvpx_image resource) throws Exception
	{
		resource.validate("delete");
		return ((xen_panwvpx_image[]) resource.delete_resource(client))[0];
	}
	 ...
	 * </pre>
	 */
	public static xen_panwvpx_image[] delete(nitro_service client, xen_panwvpx_image[] resources) throws Exception
	{
		if(resources == null)
		...
		if(resources.length == 1)
			return ((xen_panwvpx_image[]) resources[0].delete_resource(client));
		
		return ((xen_panwvpx_image[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static xen_panwvpx_image[] get(nitro_service client) throws Exception
	{
		xen_panwvpx_image resource = new xen_panwvpx_image();
		resource.validate("get");
		return (xen_panwvpx_image[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get panw XVA file.
	 */
	public static xen_panwvpx_image get(nitro_service client, xen_panwvpx_image resource) throws Exception
	{
		resource.validate("get");
		return ((xen_panwvpx_image[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get panw XVA file in bulk.
	 * </pre>
	 */
	...
	*/
	public static xen_panwvpx_image[] get_filtered(nitro_service service, String filter) throws Exception
	{
		xen_panwvpx_image obj = new xen_panwvpx_image();
		options option = new options();
		option.set_filter(filter);
		xen_panwvpx_image[] response = (xen_panwvpx_image[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static xen_panwvpx_image[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		xen_panwvpx_image obj = new xen_panwvpx_image();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_panwvpx_image[] response = (xen_panwvpx_image[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_panwvpx_image_response result = (xen_panwvpx_image_response) service.get_payload_formatter().string_to_resource(xen_panwvpx_image_response.class, response);
		...
		return result.xen_panwvpx_image;
	}
