...
class xen_sf_storagecentervpx_image_responses extends base_response
{
	public xen_sf_storagecentervpx_image_response[] xen_sf_storagecentervpx_image_response_array;
}
...
public class xen_sf_storagecentervpx_image extends base_resource
{
	...
	{
		return "xen_sf_storagecentervpx_image";
	}
	 ...
	 * </pre>
	 */
	public static xen_sf_storagecentervpx_image[] delete(nitro_service client, xen_sf_storagecentervpx_image[] resources) throws Exception
	{
		if(resources == null)
		...
		if(resources.length == 1)
			return ((xen_sf_storagecentervpx_image[]) resources[0].delete_resource(client));
		
		return ((xen_sf_storagecentervpx_image[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static xen_sf_storagecentervpx_image[] get(nitro_service client) throws Exception
	{
		xen_sf_storagecentervpx_image resource = new xen_sf_storagecentervpx_image();
		resource.validate("get");
		return (xen_sf_storagecentervpx_image[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get sf_storagecenter XVA file.
	 */
	public static xen_sf_storagecentervpx_image get(nitro_service client, xen_sf_storagecentervpx_image resource) throws Exception
	{
		resource.validate("get");
		return ((xen_sf_storagecentervpx_image[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get sf_storagecenter XVA file in bulk.
	 * </pre>
	 */
	...
	*/
	public static xen_sf_storagecentervpx_image[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		xen_sf_storagecentervpx_image obj = new xen_sf_storagecentervpx_image();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_sf_storagecentervpx_image[] response = (xen_sf_storagecentervpx_image[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_sf_storagecentervpx_image_response result = (xen_sf_storagecentervpx_image_response) service.get_payload_formatter().string_to_resource(xen_sf_storagecentervpx_image_response.class, response);
