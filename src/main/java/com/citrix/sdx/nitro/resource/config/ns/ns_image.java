...
class ns_image_response extends base_response
{
	public ns_image[] ns_image;
}

class ns_image_responses extends base_response
{
	public ns_image_response[] ns_image_response_array;
}
...
public class ns_image extends base_resource
{
	 ...
	 * </pre>
	 */
	public static ns_image delete(nitro_service client, ns_image resource) throws Exception
	{
		resource.validate("delete");
		return ((ns_image[]) resource.delete_resource(client))[0];
	}
	 ...
	 * </pre>
	 */
	public static ns_image[] delete(nitro_service client, ns_image[] resources) throws Exception
	{
		if(resources == null)
		...
		if(resources.length == 1)
			return ((ns_image[]) resources[0].delete_resource(client));
		
		return ((ns_image[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static ns_image[] get(nitro_service client) throws Exception
	{
		ns_image resource = new ns_image();
		resource.validate("get");
		return (ns_image[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get NetScaler build file.
	 */
	public static ns_image get(nitro_service client, ns_image resource) throws Exception
	{
		resource.validate("get");
		return ((ns_image[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get NetScaler build file in bulk.
	 * </pre>
	 */
	...
	*/
	public static ns_image[] get_filtered(nitro_service service, String filter) throws Exception
	{
	...
	*/
	public static ns_image[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		ns_image obj = new ns_image();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		ns_image[] response = (ns_image[])obj.get_resources(service, option);
	...
	*/
	...
	{
		ns_image_response result = (ns_image_response) service.get_payload_formatter().string_to_resource(ns_image_response.class, response);
