...
class xen_image_responses extends base_response
{
	public xen_image_response[] xen_image_response_array;
}
...
public class xen_image extends base_resource
{
	 ...
	 * </pre>
	 */
	public static xen_image[] delete(nitro_service client, xen_image[] resources) throws Exception
	{
		if(resources == null)
		...
		if(resources.length == 1)
			return ((xen_image[]) resources[0].delete_resource(client));
		
		return ((xen_image[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static xen_image[] get(nitro_service client) throws Exception
	{
		xen_image resource = new xen_image();
		resource.validate("get");
		return (xen_image[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get XenServer ISO image files.
	 */
	public static xen_image get(nitro_service client, xen_image resource) throws Exception
	{
		resource.validate("get");
		return ((xen_image[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get XenServer ISO image files in bulk.
	 * </pre>
	 */
	...
	*/
	public static xen_image[] get_filtered(nitro_service service, String filter) throws Exception
	{
		xen_image obj = new xen_image();
		options option = new options();
		option.set_filter(filter);
		xen_image[] response = (xen_image[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static xen_image[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		xen_image obj = new xen_image();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_image[] response = (xen_image[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_image_response result = (xen_image_response) service.get_payload_formatter().string_to_resource(xen_image_response.class, response);
	...
	{
		xen_image_responses result = (xen_image_responses) service.get_payload_formatter().string_to_resource(xen_image_responses.class, response);
		if(result.errorcode != 0)
		{
			if (result.errorcode == SESSION_NOT_EXISTS)
				service.clear_session();
			throw new nitro_exception(result.message, result.errorcode, (base_response [])result.xen_image_response_array);
		}
		xen_image[] result_xen_image = new xen_image[result.xen_image_response_array.length];
		
		for(int i = 0; i < result.xen_image_response_array.length; i++)
		{
			result_xen_image[i] = result.xen_image_response_array[i].xen_image[0];
		}
		
		return result_xen_image;
	}
