...
class xen_nsvpx_image_response extends base_response
{
	public xen_nsvpx_image[] xen_nsvpx_image;
}

class xen_nsvpx_image_responses extends base_response
{
	public xen_nsvpx_image_response[] xen_nsvpx_image_response_array;
}
...
public class xen_nsvpx_image extends base_resource
{
	 ...
	 * </pre>
	 */
	public static xen_nsvpx_image[] delete(nitro_service client, xen_nsvpx_image[] resources) throws Exception
	{
		if(resources == null)
		...
		if(resources.length == 1)
			return ((xen_nsvpx_image[]) resources[0].delete_resource(client));
		
		return ((xen_nsvpx_image[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static xen_nsvpx_image[] get(nitro_service client) throws Exception
	{
		xen_nsvpx_image resource = new xen_nsvpx_image();
		resource.validate("get");
		return (xen_nsvpx_image[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get NetScaler XVA file.
	 */
	public static xen_nsvpx_image get(nitro_service client, xen_nsvpx_image resource) throws Exception
	{
		resource.validate("get");
		return ((xen_nsvpx_image[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get NetScaler XVA file in bulk.
	 * </pre>
	 */
	...
	*/
	public static xen_nsvpx_image[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		xen_nsvpx_image obj = new xen_nsvpx_image();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_nsvpx_image[] response = (xen_nsvpx_image[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_nsvpx_image_response result = (xen_nsvpx_image_response) service.get_payload_formatter().string_to_resource(xen_nsvpx_image_response.class, response);
	...
	protected base_resource[] get_nitro_bulk_response(nitro_service service, String response) throws Exception
	{
		...
		if(result.errorcode != 0)
		{
			if (result.errorcode == SESSION_NOT_EXISTS)
				service.clear_session();
			throw new nitro_exception(result.message, result.errorcode, (base_response [])result.xen_nsvpx_image_response_array);
		}
		xen_nsvpx_image[] result_xen_nsvpx_image = new xen_nsvpx_image[result.xen_nsvpx_image_response_array.length];
		
		for(int i = 0; i < result.xen_nsvpx_image_response_array.length; i++)
		{
			result_xen_nsvpx_image[i] = result.xen_nsvpx_image_response_array[i].xen_nsvpx_image[0];
		}
		
		return result_xen_nsvpx_image;
	}
