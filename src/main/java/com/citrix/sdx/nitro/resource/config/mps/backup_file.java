...
class backup_file_response extends base_response
{
	public backup_file[] backup_file;
}

class backup_file_responses extends base_response
{
	public backup_file_response[] backup_file_response_array;
}
...
public class backup_file extends base_resource
{
	 ...
	 * </pre>
	 */
	public static backup_file delete(nitro_service client, backup_file resource) throws Exception
	{
		resource.validate("delete");
		return ((backup_file[]) resource.delete_resource(client))[0];
	}
	 ...
	 * </pre>
	 */
	public static backup_file[] delete(nitro_service client, backup_file[] resources) throws Exception
	{
		if(resources == null)
		...
		if(resources.length == 1)
			return ((backup_file[]) resources[0].delete_resource(client));
		
		return ((backup_file[]) delete_bulk_request(client, resources));
	}
	 ...
	 * </pre>
	 */
	public static backup_file[] get(nitro_service client) throws Exception
	{
		backup_file resource = new backup_file();
		resource.validate("get");
		return (backup_file[]) resource.get_resources(client);
	}

	/**
	 * Use this operation to get backup file.
	 */
	public static backup_file get(nitro_service client, backup_file resource) throws Exception
	{
		resource.validate("get");
		return ((backup_file[]) resource.get_resources(client))[0];
	}

	/**
	 * <pre>
	 * Use this operation to get backup file in bulk.
	 * </pre>
	 */
	...
	*/
	public static backup_file[] get_filtered(nitro_service service, String filter) throws Exception
	{
		backup_file obj = new backup_file();
		options option = new options();
		option.set_filter(filter);
		backup_file[] response = (backup_file[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static backup_file[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		backup_file obj = new backup_file();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		backup_file[] response = (backup_file[])obj.get_resources(service, option);
	...
	*/
	...
	{
		backup_file_response result = (backup_file_response) service.get_payload_formatter().string_to_resource(backup_file_response.class, response);
