...
class xen_health_monitor_temp_response extends base_response
{
	public xen_health_monitor_temp[] xen_health_monitor_temp;
}

class xen_health_monitor_temp_responses extends base_response
{
	public xen_health_monitor_temp_response[] xen_health_monitor_temp_response_array;
}
...
public class xen_health_monitor_temp extends xen_health_monitor
{
	private Long __count;

	protected String get_object_type()
	{
		return "xen_health_monitor_temp";
	}
	...
	*/
	public static xen_health_monitor_temp[] get_filtered(nitro_service service, String filter) throws Exception
	{
	...
	*/
	public static xen_health_monitor_temp[] get_filtered(nitro_service service, filtervalue[] filter) throws Exception
	{
		xen_health_monitor_temp obj = new xen_health_monitor_temp();
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service) throws Exception
	{
		...
		xen_health_monitor_temp[] response = (xen_health_monitor_temp[])obj.get_resources(service, option);
	...
	*/
	...
	{
		xen_health_monitor_temp_response result = (xen_health_monitor_temp_response) service.get_payload_formatter().string_to_resource(xen_health_monitor_temp_response.class, response);
		...
		return result.xen_health_monitor_temp;
	}
