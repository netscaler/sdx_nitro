...
class xen_health_monitor_misc_response extends base_response
{
	public xen_health_monitor_misc[] xen_health_monitor_misc;
}

class xen_health_monitor_misc_responses extends base_response
{
	public xen_health_monitor_misc_response[] xen_health_monitor_misc_response_array;
}
...
public class xen_health_monitor_misc extends xen_health_monitor
{
	private Long __count;

	protected String get_object_type()
	{
		return "xen_health_monitor_misc";
	}
	 ...
	 * </pre>
	 */
	public static xen_health_monitor_misc[] get(nitro_service client) throws Exception
	{
		xen_health_monitor_misc resource = new xen_health_monitor_misc();
		resource.validate("get");
		return (xen_health_monitor_misc[]) resource.get_resources(client);
	}
	...
	*/
	...
	{
		xen_health_monitor_misc_response result = (xen_health_monitor_misc_response) service.get_payload_formatter().string_to_resource(xen_health_monitor_misc_response.class, response);
		...
		return result.xen_health_monitor_misc;
	}
